...
class AgcOatProductionCostResultsPlaceholder {
    render() {
    ...
    static get is() { return "agc-oat-production-cost-results-placeholder"; }
}

export { AgcOatProductionCostResultsPlaceholder };
